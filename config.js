...
export const characterControllerScriptUUID = %YOUR_CHARACTER_CONTROLLER_SCRIPT_UUID%;
export const spawnPosition = [0,2,0];

export let clientData = { characterController: null, };